...
tag: project
order: 3
summary: Un projet qui tourne 24h/24 depuis 4 ans, avec plusieurs milliers de lignes de code.
link_label: details
link_url: "#"
lang: fr
...
Pour se donner une idée, ce projet, c'est: 
- Environ 7000 lignes de code
- Un peu plus de 2 000 000 de requêtes pour récupérer de la donnée.
- Beaucoup de technologies différentes: de l'asynchrone, Pillow, Selenium, SQLite3, ...
- Une excellente manière pour moi de réaliser comment avoir des projets tournant au long terme, sur des serveurs distants.

Voici un graphe rapide des technologies utilisées: (Je rappelle que le code est disponible à https://github.com/pacomef/ProjectEulerBot)
