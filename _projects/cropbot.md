...
Ceci est un projet que j'ai réalisé en 2020, et je le mets dans ce dossier car c'est sans doute l'un de mes tous premiers projets et je l'aime bien, même s'il n'est pas grandiose.
...
Le principe était de tracer quatre lignes, partant des 4 côtés de l'image, et de détecter la plus grande distance pouvant être parcourue sans que les pixels ne changent d'un certain delta donné. 

Le bot a dû être utilisé en tout et pour tout une centaine de fois. (Des fois pour des images questionnables, donc ne vous aventurez peut être pas trop loin si vous commencez à explorer les "exploits" du bot.)
